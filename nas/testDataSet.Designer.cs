...
namespace nas {
    ...
    public partial class testDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(string Id, string name, string phone, string pass) {
...
namespace nas.testDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([name] = @Original_na" +
                "me) AND ([phone] = @Original_phone) AND ([pass] = @Original_pass))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [name], [phone], [pass]) VALUES (@Id, @name, @ph" +
                "one, @pass);\r\nSELECT Id, name, phone, pass FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [name] = @name, [phone] = @phone, [pass] = @pass WHERE (([Id] = @Original_Id) AND ([name] = @Original_name) AND ([phone] = @Original_phone) AND ([pass] = @Original_pass));
SELECT Id, name, phone, pass FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, phone, pass FROM dbo.[Table]";
        ...
        public virtual int Delete(string Original_Id, string Original_name, string Original_phone, string Original_pass) {
            if ((Original_Id == null)) {
        ...
        public virtual int Insert(string Id, string name, string phone, string pass) {
            if ((Id == null)) {
        ...
        public virtual int Update(string Id, string name, string phone, string pass, string Original_Id, string Original_name, string Original_phone, string Original_pass) {
            if ((Id == null)) {
                throw new global::System.ArgumentNullException("Id");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string phone, string pass, string Original_Id, string Original_name, string Original_phone, string Original_pass) {
            return this.Update(Original_Id, name, phone, pass, Original_Id, Original_name, Original_phone, Original_pass);
        }
    }
