...
namespace nas {
    ...
    public partial class testDataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(string Id, string name, string phone, string pass, string chk) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string chk {
                get {
                    try {
                        return ((string)(this[this.tableTable.chkColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("\'Table\' 테이블의 \'chk\' 열의 값이 DBNull입니다.", e);
                    }
                }
                set {
                    this[this.tableTable.chkColumn] = value;
                }
            }
            ...
            public bool IschkNull() {
                return this.IsNull(this.tableTable.chkColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetchkNull() {
                this[this.tableTable.chkColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace nas.testDataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([name] = @Original_na" +
                "me) AND ([phone] = @Original_phone) AND ([pass] = @Original_pass) AND ((@IsNull_" +
                "chk = 1 AND [chk] IS NULL) OR ([chk] = @Original_chk)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_chk", global::System.Data.SqlDbType.Char, 0, global::System.Data.ParameterDirection.Input, 0, 0, "chk", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [name], [phone], [pass], [chk]) VALUES (@Id, @na" +
                "me, @phone, @pass, @chk);\r\nSELECT Id, name, phone, pass, chk FROM [Table] WHERE " +
                "(Id = @Id)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@chk", global::System.Data.SqlDbType.Char, 0, global::System.Data.ParameterDirection.Input, 0, 0, "chk", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [name] = @name, [phone] = @phone, [pass] = @pass, [chk] = @chk WHERE (([Id] = @Original_Id) AND ([name] = @Original_name) AND ([phone] = @Original_phone) AND ([pass] = @Original_pass) AND ((@IsNull_chk = 1 AND [chk] IS NULL) OR ([chk] = @Original_chk)));
SELECT Id, name, phone, pass, chk FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@chk", global::System.Data.SqlDbType.Char, 0, global::System.Data.ParameterDirection.Input, 0, 0, "chk", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_chk", global::System.Data.SqlDbType.Char, 0, global::System.Data.ParameterDirection.Input, 0, 0, "chk", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::nas.Properties.Settings.Default.testConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, phone, pass, chk FROM dbo.[Table] WHERE chk=\'Y\'";
        ...
        public virtual int Delete(string Original_Id, string Original_name, string Original_phone, string Original_pass, string Original_chk) {
            if ((Original_Id == null)) {
            ...
            if ((Original_chk == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_chk));
            }
        ...
        public virtual int Insert(string Id, string name, string phone, string pass, string chk) {
            if ((Id == null)) {
            ...
            if ((chk == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(chk));
            }
        ...
        public virtual int Update(string Id, string name, string phone, string pass, string chk, string Original_Id, string Original_name, string Original_phone, string Original_pass, string Original_chk) {
            if ((Id == null)) {
                throw new global::System.ArgumentNullException("Id");
            }
            else {
            ...
            if ((chk == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(chk));
            }
            if ((Original_Id == null)) {
                throw new global::System.ArgumentNullException("Original_Id");
            }
            ...
            if ((Original_chk == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_chk));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string phone, string pass, string chk, string Original_Id, string Original_name, string Original_phone, string Original_pass, string Original_chk) {
            return this.Update(Original_Id, name, phone, pass, chk, Original_Id, Original_name, Original_phone, Original_pass, Original_chk);
        }
    }
